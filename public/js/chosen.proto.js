...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_values = function() {
      ...
      this.use_doubledrop = this.options.use_doubledrop || false;
  ...
  this.Chosen = (function(_super) {
    ...
    Chosen.prototype.set_default_values = function() {
      ...
      var dropclass = 'chosen-drop';
      if (this.use_doubledrop) {
    	  dropclass = dropclass + '-doublewidth';
      }
      if (this.form_field.hasClassName("whitebg")) {
    	  this.single_temp = new Template('<a class="chosen-single chosen-default" style="background-color: #FFF;" tabindex="-1"><span>#{default}</span><div><b></b></div></a><div class="' + dropclass + '"><div class="chosen-search"><input type="text" autocomplete="off" /></div><ul class="chosen-results"></ul></div>');
      } else {
    	  this.single_temp = new Template('<a class="chosen-single chosen-default" tabindex="-1"><span>#{default}</span><div><b></b></div></a><div class="' + dropclass + '"><div class="chosen-search"><input type="text" autocomplete="off" /></div><ul class="chosen-results"></ul></div>');
      }
      this.multi_temp = new Template('<ul class="chosen-choices"><li class="search-field"><input type="text" value="#{default}" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="' + dropclass + '"><ul class="chosen-results"></ul></div>');
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      this.dropdown = this.container.down('div.' + dropclass);
